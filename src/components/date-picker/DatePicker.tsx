...
const DatePicker = ( props: IDatePicker ) => {
	...
	const showMonthsCount = typeof props.showMonthsCount !== 'undefined' ? props.showMonthsCount : DatePickerProps.showMonthsCount;
	...
	const selectPicker = ( data: IDatePickerData ) => {
		...
		if ( data.value !== 'customRange' ) {
			...
			typeof setStartDate === 'function' && setStartDate( new Date( data.startDate ) );
			typeof setEndDate === 'function' && setEndDate( new Date( data.endDate ) );
		}

...
http://localhost/wpex/wp-admin/admin.php?page=innovator-ai#/
...
1. **Job Types**
    - Method: `GET`
    - URL: http://localhost/wpex/wp-json/innovator-ai/v1/job-types
1. **Companies dropdown**
    - Method: `GET`
    - URL: http://localhost/wpex/wp-json/innovator-ai/v1/companies/dropdown
1. **Job Lists**
    - Method: `GET`
    - URL: http://localhost/wpex/wp-json/innovator-ai/v1/jobs
1. **Job Details**
    - Method: `GET`
    - URL By ID: http://localhost/wpex/wp-json/innovator-ai/v1/jobs/1
    - URL By Slug: http://localhost/wpex/wp-json/innovator-ai/v1/jobs/first-job
1. **Create Job**
    - Method: `POST`
    - URL: http://localhost/wpex/wp-json/innovator-ai/v1/Jobs
    - Body:
...
1. **Update Job**
    - Method: `PUT`
    - URL: http://localhost/wpex/wp-json/innovator-ai/v1/jobs/1
    - Body:
    ```json
    {
...
```sh
vendor/bin/phpcs innovator-ai.php
```


**Fix specific file errors of the project:**
```sh
vendor/bin/phpcbf innovator-ai.php
```
</details>
